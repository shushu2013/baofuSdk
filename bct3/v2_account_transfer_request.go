...
// 转账（账户间）接口
// https://docs.baofu.com/docs/bct3/bct3-3001-001-01
func AccountTransferRequest(config *BCT3Config, req *AccTransferReq) (*AccTransferResp, error) {
	// 服务编号
	serviceTp := SERVICE_ACCOUNT_TRANSFER
