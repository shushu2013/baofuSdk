...
// 账户绑定关系查询接口
// https://docs.baofu.com/docs/bct3/bct3-1gahlm7oj07i5
func AccountBindRelationQueryRequest(config *BCT3Config, req *AccBindRelationQueryReq) (*AccBindRelationQueryResp, error) {
	// 服务编号
	serviceTp := SERVICE_ACCOUNT_BIND_RELATION_QUERY
