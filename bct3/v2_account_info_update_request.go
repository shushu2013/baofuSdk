...
// 账户信息修改接口
// https://docs.baofu.com/docs/bct3/bct3-1g42ca003pfad
func AccountInfoUpdateRequest(config *BCT3Config, req *AccInfoUpdateReq) (*AccInfoUpdateResp, error) {
	// 服务编号
	serviceTp := SERVICE_ACCOUNT_UPDATE
	// 创建AES密钥
