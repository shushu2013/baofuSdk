...
func TestAgreementPrePay(t *testing.T) {
	...
	transId := "TID048127398CAA3310EA58"                                  // tool.GetMsgId()
	...
	riskItem := map[string]string{
		...
		"chName":           "王勇",                  //持卡人姓名
		"chIdNo":           "310115200501018559",  //持卡人身份证号
		"chCardNo":         "6222021001015343573", //持卡人银行卡号
		"chMobile":         "18616092709",         //持卡人手机
		"chPayIp":          "116.216.217.170",     //持卡人支付IP
		"deviceOrderNo":    "",                    //加载设备指纹中的订单号

		/**--------行业参数  (以下为游戏行业风控参，请参看接口文档附录风控参数)-------------**/
		"gameName":       "测试游戏",        //充值游戏名称
	...
	resp, err := AgreementPrePay(config, reqMap)
	if err != nil {
		t.Errorf("AgreementPrePay failed: %v", err)
	}
